        ...
        <div class="col-12">
            <div class="card h-100 mb-0">
                ...
                <div class="card-body">
                    ...
                    <p class="text-muted mb-4">Tooltip example are available with follwing options, Directions are mirrored
                        when using Bootstrap in RTL.</p>

                    <div class="d-flex flex-wrap align-items-center gap-3">
                        <button type="button" class="btn btn-primary" data-bs-toggle="tooltip"
                            data-bs-custom-class="tooltip-white" data-bs-placement="top" data-bs-title="Tooltip on top">
                            Tooltip on top
                        </button>
                        <button type="button" class="btn btn-primary" data-bs-toggle="tooltip"
                            data-bs-custom-class="tooltip-white" data-bs-placement="right" data-bs-title="Tooltip on right">
                            Tooltip on right
                        </button>
                        <button type="button" class="btn btn-primary" data-bs-toggle="tooltip"
                        ...
                        <button type="button" class="btn btn-primary" data-bs-toggle="tooltip"
                            data-bs-custom-class="tooltip-white" data-bs-placement="left" data-bs-title="Tooltip on left">
                            Tooltip on left
                        </button>
                    </div>
        ...
        <div class="col-12">
            <div class="card h-100 mb-0">
                ...
                <div class="card-body">
                    ...
                    <p class="text-muted mb-4">When you hover over the button labeled "Tooltip with HTML," a tooltip will
                        ...
                        <code>`data-bs-html="true"`</code> attribute allows the tooltip to render HTML tags correctly.</p>
            ...
            <div class="card h-100 mb-0">
                ...
                <div class="card-body">
                    ...
                    <p class="text-muted mb-0">This is sample text intended to showcase some
                        ...
                        with tooltips. Currently, it serves as placeholder content—essentially filler—meant to illustrate
                        how
                        ...
                        <a href="#!" data-bs-toggle="tooltip" data-bs-title="Tooltip for tooltips on links">tooltips on
                            links</a>
        ...
        <div class="col-12">
            <div class="card h-100 mb-0">
                ...
                <div class="card-body">
                    ...
                    <p class="text-muted mb-4">Use the <code> data-bs-custom-class="tooltip-*" </code> attribute to apply a
                        custom tooltip style with a primary color theme. This allows you to customize the appearance of the
                        tooltip, giving it a distinct look that matches the primary color scheme of your application.</p>
                    ...
                    <div class="d-flex flex-wrap align-items-center gap-3">
                        ...
                        <button type="button" class="btn btn-secondary" data-bs-custom-class="tooltip-secondary"
                            data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Tooltip on top">
                            Secondary Tooltip
                        </button>
