...
class CategorySeeder extends Seeder
{
    public function run(): void
    {
        ...
        /*
         * Volume Score System:
         *   Small Item  = 0.5 - 2.5 points
         *   Medium Item = 2.5 - 4.5 points
         *   Large Item  = 4.5 - 7.5 points
         *
        ...
        foreach ($categories as $c) {
            ...
            $data[] = [
                ...
                'price_per_point' => $c['price_per_point'],
                'status'          => $c['status'],
                'created_at'      => now(),
                'updated_at'      => now(),
            ];
